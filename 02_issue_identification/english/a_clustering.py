...
os.makedirs("output_english", exist_ok=True)
os.makedirs("output_english/clusters", exist_ok=True)
...
def save_articles_by_cluster(items, labels, output_file="output_english/articles_with_clusters.json"):
    ...
    df.to_csv("output_english/article_clusters_summary.csv", index=False)
    ...
    with open("output_english/cluster_stats.txt", "w") as f:
...
if __name__ == "__main__":
    ...
    print(f"- Full data with clusters saved to output_english/articles_with_clusters.json")
    print(f"- Summary CSV saved to output_english/article_clusters_summary.csv")
    print(f"- Cluster statistics saved to output_english/cluster_stats.txt")